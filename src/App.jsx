...
// ==========================================
// 台股子系統元件：TwStocksDashboard (新增隔日沖分頁)
// ==========================================
...
const CryptoAdvancedKLineChart = ({ klines, signalData }) => {
  ...
  if (!klines || dataLen === 0) return <div className="w-full h-[500px] flex items-center justify-center text-slate-500">圖表數據載入中...</div>;
